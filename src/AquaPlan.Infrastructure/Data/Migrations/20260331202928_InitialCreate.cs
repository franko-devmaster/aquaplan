        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    canton_region = table.Column<string>(type: "text", nullable: true),
                    distribution_network = table.Column<string>(type: "text", nullable: true),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_distributors_tenants_tenant_id",
                        column: x => x.tenant_id,
                        principalTable: "tenants",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_unplanned = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_orders_distributors_distributor_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_orders_users_preleveur_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_sampling_locations", x => x.id);
                    table.ForeignKey(
                        name: "fk_sampling_locations_distributors_distributor_id",
                        column: x => x.distributor_id,
                        principalTable: "distributors",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_distributors", x => new { x.user_id, x.distributor_id });
                    table.ForeignKey(
                        name: "fk_user_distributors_distributors_distributor_id",
                        column: x => x.distributor_id,
                        principalTable: "distributors",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_distributors_users_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    preleveur_id = table.Column<string>(type: "text", nullable: false),
                    sampling_date_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_samplings_orders_order_id",
                        column: x => x.order_id,
                        principalTable: "orders",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_samplings_users_preleveur_id",
                        column: x => x.preleveur_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_email_tenant_id",
                table: "AspNetUsers",
                columns: new[] { "email", "tenant_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_external_id",
                table: "AspNetUsers",
                column: "external_id",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_distributors_tenant_id",
                table: "distributors",
                column: "tenant_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sampling_locations_distributor_id",
                table: "sampling_locations",
                column: "distributor_id");

            migrationBuilder.CreateIndex(
                name: "ix_samplings_order_id",
                table: "samplings",
                column: "order_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_samplings_preleveur_id",
                table: "samplings",
                column: "preleveur_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_distributors_distributor_id",
                table: "user_distributors",
                column: "distributor_id");
        }
