...
public interface ISamplingLocationService
{
    ...
    Task<SamplingLocationListDto> GetFilteredAsync(SamplingLocationFilteringInputDto filter, Guid tenantId, IReadOnlyCollection<Guid>? authorizedDistributorIds = null, CancellationToken cancellationToken = default);
